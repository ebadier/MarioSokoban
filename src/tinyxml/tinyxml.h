...
public:
	...
	/// Visit an element.
	virtual bool VisitEnter( const TinyXmlElement& /*element*/, const TiXmlAttribute* /*firstAttribute*/ )	{ return true; }
	/// Visit an element.
...
public:
	...
	*/
	...
	TinyXmlElement* NextSiblingElement() {
		return const_cast< TinyXmlElement* >( (const_cast< const TiXmlNode* >(this))->NextSiblingElement() );
	}
	...
	*/
	...
	TinyXmlElement* NextSiblingElement( const char *_next ) {
		return const_cast< TinyXmlElement* >( (const_cast< const TiXmlNode* >(this))->NextSiblingElement( _next ) );
	}

    #ifdef TIXML_USE_STL
	const TinyXmlElement* NextSiblingElement( const std::string& _value) const	{	return NextSiblingElement (_value.c_str ());	}	///< STL std::string form.
	TinyXmlElement* NextSiblingElement( const std::string& _value)				{	return NextSiblingElement (_value.c_str ());	}	///< STL std::string form.
	#endif

	/// Convenience function to get through elements.
	const TinyXmlElement* FirstChildElement()	const;
	TinyXmlElement* FirstChildElement() {
		return const_cast< TinyXmlElement* >( (const_cast< const TiXmlNode* >(this))->FirstChildElement() );
	}

	/// Convenience function to get through elements.
	const TinyXmlElement* FirstChildElement( const char * _value ) const;
	TinyXmlElement* FirstChildElement( const char * _value ) {
		return const_cast< TinyXmlElement* >( (const_cast< const TiXmlNode* >(this))->FirstChildElement( _value ) );
	}

    #ifdef TIXML_USE_STL
	const TinyXmlElement* FirstChildElement( const std::string& _value ) const	{	return FirstChildElement (_value.c_str ());	}	///< STL std::string form.
	TinyXmlElement* FirstChildElement( const std::string& _value )				{	return FirstChildElement (_value.c_str ());	}	///< STL std::string form.
	#endif
...
*/
class TinyXmlElement : public TiXmlNode
{
public:
	...
	#ifdef TIXML_USE_STL
	/// std::string constructor.
	TinyXmlElement( const std::string& _value );
	#endif
...
/**
	...
	TinyXmlElement* child2 = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).Child( "Child", 1 ).ToElement();
	if ( child2 )
	{
		// do something useful
	@endverbatim
	...
	while ( true )
	{
		TinyXmlElement* child = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).Child( "Child", i ).ToElement();
		if ( !child )
			break;
		// do something
		++i;
	...
	@verbatim
	TinyXmlElement* child = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).FirstChild( "Child" ).ToElement();
...
public:
	...
	virtual bool VisitEnter( const TinyXmlElement& element, const TiXmlAttribute* firstAttribute );
